Rails.application.routes.draw do
  ...
  #get "users/:id/edit"
  get "users/password_reset_page"
  get "mobiles/specifications"
  
  get "mobiles/download"
  resources :users
  resources :mobiles #, only: [:index, :show, :edit, :new] #when we need only few pages not all.
